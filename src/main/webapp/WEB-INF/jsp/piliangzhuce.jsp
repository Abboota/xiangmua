...
<body>
        <h1 align="center"><button>批量注册学生页面</button></h1>
       <form method="post" align="center" id="form1">
        ...
        <form method="post" align="center" id="form2">
            <table align="center">
                <tr>
                    <td align="center">手机号</td>
                    <td><input type="text" name="uid" placeholder="请输入手机号"></td>
...
<script type="text/javascript">
    ...
    function zhuce() {
            ...
            $.post("${pageContext.request.contextPath}/kjfl/zhuce2",$("#form1").serialize(),
                function (data) {
                if (data.success) {
                    alert(data.message);
                }else {
            ...
            $.post("${pageContext.request.contextPath}/kjfl/zhuce2",$("#form2").serialize(),
                function (data) {
                if (data.success) {
                    alert(data.message);
                }else {
